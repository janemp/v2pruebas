    ...
    <v-data-table
        ...
        <template slot="items" slot-scope="props">
          <tr>
            ...
            <td class="text-xs-center" @click="props.expanded = !props.expanded"> {{ props.item.nit }} </td>
            <td class="text-xs-center" @click="props.expanded = !props.expanded"> {{ props.item.numero_fundempresa }} </td>
              ...
              <v-layout row wrap>
                ...
                <v-flex xs9>
                  <table class="v-table theme--light">
                    <tr>
                      <th class="text-xs-left">Dirección de empresa: </th>
                      <td class="text-xs-left">{{ props.item.direccion }}</td>
                    </tr>
                    <tr>
                      <th class="text-xs-left">Telefono de empresa: </th>
...
export default {
  ...
  methods: {
    async getTable() {
      try {
        let res = await axios.get("api/empresa")
        this.table = res.data
