        ...
        <template slot="items" slot-scope="props">
          <tr>
            ...
            <td class="text-xs-center" @click="props.expanded = !props.expanded">
              <div v-if="props.item.tipo_persona_id">
            ...
            <td class="justify-center layout">              
              <v-tooltip top>
                <v-btn slot="activator" flat icon color="indigo" @click="retencionItem(props.item)">
          ...
          <v-card flat color="blue-grey lighten-5">
            <v-card-text >
              <v-layout row wrap>
                ...
                <v-flex xs9>
                  <table class="v-table theme--light" v-if="props.item.tipo_persona_id">
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="text-xs-left">{{ (props.item.genero=='M')?'Masculino':((props.item.genero=='F')?'Femenino':'-') }}</td>
                    </tr>                  
                    <tr>
...
import RetencionPersona from "./Retencion_persona"
