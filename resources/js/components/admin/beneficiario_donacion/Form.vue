              ...
              <v-stepper-content step="1">
                <v-form ref="form1" v-model="valid" lazy-validation>
                  <v-text-field
                    ...
                    label="Nombre de organización beneficiaria de donación"
      ...
      try {
        ...
        if (this.$refs.form2.validate()) {
          ...
          if (this.selectedIndex != -1) {            
            ...
            await axios.put("api/beneficiario_donacion/"+this.selectedEmpresa.id, this.selectedEmpresa)
          } else {
            this.selectedItem.tipo_persona_id = 6
            let res = await axios.post("api/persona", this.selectedItem)
            this.selectedEmpresa.persona_id = res.data.id
            await axios.post("api/beneficiario_donacion", this.selectedEmpresa)
          }
