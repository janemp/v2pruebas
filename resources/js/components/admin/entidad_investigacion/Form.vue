              ...
              <v-stepper-content step="1">
                <v-form ref="form1" v-model="valid" lazy-validation>
                  <v-text-field
                    ...
                    label="Nombre de instituto o entidad de investigación"
      ...
      try {
        ...
        if (this.$refs.form2.validate()) {
          ...
          if (this.selectedIndex != -1) {            
            ...
            await axios.put("api/entidad_investigacion/"+this.selectedEmpresa.id, this.selectedEmpresa)
          } else {
            ...
            await axios.post("api/entidad_investigacion", this.selectedEmpresa)
          }
